            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                  ...
                  <a class="nav-link" href="{{route('agregar_cliente')}}">Registrar cliente</a>
                  <a class="nav-link" href="{{route('ver_cliente')}}">Ver cliente</a>
                  <a class="nav-link " href="{{route('producto_venta')}}" >Ver Productos</a>
                  <a class="nav-link " href="{{route('ver_pedido')}}" >Ver Pedidos</a>
